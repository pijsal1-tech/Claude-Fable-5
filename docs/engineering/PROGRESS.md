...
| current-task | **TSK-729 مغلقة 🏁 (BATCH-P3/D-11)**: تصليب درز redis (fakeredis توافق في كل بوابة + حارس عدم التسرّب + FI-12 §7) — التالي تفصيل TSK-730/731؛ خط الأساس الجديد: **2109P/34S** |
