...
| current-task | **TSK-731 قيد التنفيذ (BATCH-P3/D-11)**: auto-update مُكيَّفة إلى فحص تحديث يدوي opt-in (731a مقارنة إصدارات + 731b GET /api/update-check معطَّلة افتراضيًا + 731c توثيق القناة اليدوية) — التثبيت الآلي مؤجل لتأشير المالك (727)؛ خط الأساس: **2120P/34S** |
