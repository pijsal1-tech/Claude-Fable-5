...
| current-task | **القرار 7 مُغلق 🏁 (TSK-735 كامل: 735a 71b5f8e + 735b a645b4e/e7875b0 + 735c 037175f/11aa183 + إغلاق التوثيق)** — الاستبعاد الثنائي على التكاملات القديمة في providers/ عاد سارياً (حدود D-20)؛ كود TSK-735 الجديد داخل النطاق الأساسي دائمًا. **التالي: القرار 8 من تسلسل D-19 (ACP) — تخطيط أولًا (إجراء D-7)** |
