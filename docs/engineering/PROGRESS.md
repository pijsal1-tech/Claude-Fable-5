...
| current-task | **TSK-728 قيد التنفيذ (BATCH-P3/D-11)**: التفصيل النهائي مكتمل (جرد الحقن: CommandRunner.run يغطي المسارين، write_file نقطة الكتابة) — التالي شريحة 728a (core/hooks.py + اختبارات نقية)؛ خط الأساس: **2058P/34S** |
