...
| Field | Value |
|---|---|
| last-updated | 2026-08-02 (Session 108 تكملة 8 — **CEV-G10 🏁 PASS**: المنافسون — جدول بالدليل CP-10..17 (VSCode+JetBrains أدلة رسمية جديدة، Cursor/Zed/Windsurf/Claude Code/Copilot مستهلَكة بإحالة R0.2/R9.1)؛ المستحق ⇒ FI-15/FI-16 بقرار مالك؛ التالي G11 الدين التقني) |
