...
3. **الانحدار**: `bash scripts/check.sh` @ `f5144c1` (2026-08-04) =
   **2576 passed / 34 skipped / 0 failed — ALL GREEN rc=0** — **تشغيلتان
   مستقلتان متطابقتان** (91.80s ثم 93.05s، الثانية على شجرة مُستعادة بعد
   مسح بيئة ⇒ إعادة إنتاج مُثبتة لا تشغيلة محظوظة واحدة).
